        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-32 text-center">
          ...
          >
            ...
            >
              ...
              <span className="font-bold shimmer-text">5.0 Star Google Rating</span>
              <span className="text-black/30">•</span>
              <span className="font-bold shimmer-text">100% Eggless Kitchen</span>
            </div>
          </motion.div>
        ...
        >
          <div className="max-w-full mx-auto px-4 sm:px-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 mb-10">
              ...
              >
                <Instagram size={22} className="text-gold group-hover:text-gold-bright transition-colors" />
                <div className="text-[11px] text-muted-foreground">Instagram</div>
                <div className="text-gold font-semibold text-xs sm:text-sm whitespace-nowrap">
                  @THE_CRAVECOACH
                </div>
              </a>
              ...
              <a
                ...
                data-ocid="contact.link"
              >
                <Mail size={22} className="text-gold group-hover:text-gold-bright transition-colors" />
              ...
              <a
                ...
                data-ocid="contact.link"
              >
                <Phone size={22} className="text-gold group-hover:text-gold-bright transition-colors" />
              ...
              {/* Location */}
              {/* Location Card (Clickable on both Desktop & Mobile) */}
              <a
                ...
                data-ocid="contact.link"
              >
                <MapPin size={22} className="text-gold group-hover:text-gold-bright transition-colors" />
              ...
              >
                ...
                <div className="text-gold font-semibold text-xs sm:text-sm whitespace-nowrap group-hover:underline">
                  5.0 ★ (50+ Reviews)
                </div>
              </a>
            </div>
